...
All notable changes to SCH are documented here.
...
- Recorded the current repository purpose: SCH is the working repository for Richard Schmidt's Nachtraege zum Sanskrit-Woerterbuch, a continuation/supplement related to the Petersburger Woerterbuch tradition.
